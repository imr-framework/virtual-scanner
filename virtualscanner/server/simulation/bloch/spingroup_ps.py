...
class SpinGroup:
    ...
    -------
    get_m_signal()
        Get current magnetization in complex form.
    fpwg(grad_area, t)
        Free precession with gradients.
    delay(t)
        Free precession without gradients.
    apply_rf(pulse_shape, grads_shape, dt)
        Apply RF pulse with gradient.
    readout(dwell,n,delay,grad,timing)
        Take multiple samples of the magnetization with gradient applied.
