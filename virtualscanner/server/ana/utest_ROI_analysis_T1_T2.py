...
class MyTestCase(unittest.TestCase):
    ...
    def test_T1_ROI_analysis(self):
        ...
        """
        platform = {'win32': 'utest_T1_map_with_ROI_windows.png',
                    'darwin': 'utest_T1_map_with_ROI_mac.png'}
        filename = platform[sys.platform]
        ...
        utest_ROI = imread(SERVER_T1_MAP_PATH / filename)
    ...
    def test_T2_ROI_analysis(self):
        ...
        """
        platform = {'win32': 'utest_T2_map_with_ROI_windows.png',
                    'darwin': 'utest_T2_map_with_ROI_mac.png'}
        filename = platform[sys.platform]
        roi_filename = dicomROIanalysis.main(dicom_map_path=SERVER_T2_MAP_PATH, map_type='T2', map_size='128',
                                                fov='210', pat_id='9306')
        generated_ROI = imread(COMS_MAP_PATH / roi_filename)
        utest_ROI = imread(SERVER_T2_MAP_PATH / filename)
